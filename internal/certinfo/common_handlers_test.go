...
func TestCertinfo_PrintCertInfo(t *testing.T) {
	t.Run("RSA Sample Certificate", func(t *testing.T) {
		...
		require.Contains(t, got, "NotBefore")
		require.Contains(t, got, "NotAfter")
		require.Contains(t, got, "DNSNames")
		require.Contains(t, got, "IsCA")
		require.Contains(t, got, "SerialNumber")
		require.Contains(t, got, "PublicKeyAlgorithm")
		require.Contains(t, got, "SignatureAlgorithm")
	})
}
